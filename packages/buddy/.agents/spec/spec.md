...
[`clibuilder`](https://www.npmjs.com/package/clibuilder) v10, which supplies the command shell,
...
| Concept | Facets |
|---|---|
| `configuration` | `configuration/` (behavior) · `initialization/` (behavior) |
| `invocation` | `cli-shell/` (behavior) · `plugin-management/discovery/` (behavior) · `workflows/` (workflow) |
| `package-manager` | `plugin-management/add/` (behavior) · `plugin-management/package-manager/` (behavior) · `plugin-management/remove/` (behavior) · `plugin-management/update/` (behavior) |
| `plugin-activation` | `plugin-management/loading/` (behavior) · `plugin-management/plugin-contract/` (reference) · `workflows/` (workflow) |
| `plugin-registry` | `initialization/` (behavior) · `plugin-management/add/` (behavior) · `plugin-management/discovery/` (behavior) · `plugin-management/remove/` (behavior) |
| `scaffolding` | `initialization/` (behavior) |
